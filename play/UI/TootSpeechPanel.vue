  ...
  <div class="toot-speech-panel">
    <div class="panel-header">
      ...
      <div class="status-indicators">
        ...
        <span v-if="queueLength.value > 0" class="queue-indicator">{{ queueLength.value }}</span>
      </div>
    </div>
    ...
    <div class="panel-content">
      ...
      <div v-if="error" class="error-message">
        ...
        <button @click="clearSpeechError" class="btn btn-text">Dismiss</button>
      </div>
    </div>
  </div>
</template>
...
const statusTooltip = computed(() => {
  ...
  if (isInitialized()) return 'Speech service ready'
...
const clearSpeechError = () => {
  // Use the clearError method from the composable
  // Note: clearError is destructured from the composable
  // We need to call it directly from the service
  tootSpeechService.clearError()
}
