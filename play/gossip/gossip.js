...
Tootsville.gossip.linkOfferToPeer = function(peer) {
    ...
    connection.createOffer().then(offer => {
        connection.setLocalDescription(offer).then(() => {
            Tootsville.util.rest('/gossip/peer-offer',
                                 {peer: peer,
...
Tootsville.gossip.peerICECandidate = function (peer, candidate, event) {
    Tootsville.util.rest('/gossip/peer-candidate', { peer: peer,
        ...
        peerConnection.setRemoteDescription(offer).then( () => {
            ...
            peerConnection.createAnswer().then( answer => {
                peerConnection.setLocalDescription(answer).then( () => {
                    Tootsville.util.rest('/gossip/peer-answer', {name: name,
                                                                 peer: peer,
...
Tootsville.gossip.connect = function() {
    ...
    Tootsville.user.rest('/gossip/directory/', { offers: offers }).then( response => {
